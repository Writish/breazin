...
the app at `Sources/Breazin/Resources/Models/BeatThis.mlmodelc` (6.6 MB).
...
Copy `build/BeatThis.mlmodelc` into `Sources/Breazin/Resources/Models/`.
...
FP16 multiarrays — read as Float16. See `Sources/Breazin/Audio/Beats/BeatDetector.swift`.
