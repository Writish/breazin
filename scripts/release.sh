...
PLIST="$ROOT/Sources/Breazin/Resources/Info.plist"
APPCAST="$ROOT/appcast.xml"
DMG="$ROOT/.build/Breazin.dmg"
cd "$ROOT"
...
NOTES_CLEAN="$(mktemp -t breazin-release.XXXXXX).md"
...
BUILD_LOG="$(mktemp -t breazin-build.XXXXXX).log"
...
url = f"https://github.com/Writish/breazin/releases/download/v{v}/Breazin.dmg"
...
echo ""
echo "==> Released $TAG"
echo "    https://github.com/Writish/breazin/releases/tag/$TAG"
