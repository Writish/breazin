...
enum Project {
    static let fileExtension = AppConfiguration.current.projectFileExtension
    static let legacyFileExtension = AppConfiguration.legacyProjectFileExtension
    static let registryFilename = "project-registry.json"
    static let typeIdentifier = AppConfiguration.current.projectTypeIdentifier
    static let legacyTypeIdentifier = AppConfiguration.legacyProjectTypeIdentifier
    ...
    static var storageDirectory: URL {
        AppConfiguration.current.projectStorageDirectory
    }
