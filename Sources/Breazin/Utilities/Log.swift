...
/// The environment-specific Breazin log directory with a backtrace.
enum Log {
    static let subsystem  = AppConfiguration.current.logSubsystem
    ...
    static let crashLogURL = AppConfiguration.current.logDirectory
