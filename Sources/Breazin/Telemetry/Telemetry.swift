...
enum Telemetry {
    ...
    private static var enabledKey: String { "\(AppConfiguration.current.preferencesPrefix).telemetry.enabled" }
    ...
    static func start() {
        ...
        SentrySDK.start { options in
            ...
            options.environment = AppConfiguration.current.telemetryEnvironment
            ...
            if let version = Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String,
               let build = Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String {
                options.releaseName = "breazin@\(version)+\(build)"
            }
        }
        didStart = true
        #endif
