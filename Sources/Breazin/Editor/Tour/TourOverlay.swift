...
struct TourOverlay: View {
    ...
    private static let docsURL = URL(string: "https://github.com/Writish/breazin/tree/main/docs")!
...
private enum TourAssets {
    ...
    private static func load(_ name: String, ext: String) -> NSImage? {
        ...
        let candidates = [
            ...
            root.appendingPathComponent("Breazin_Breazin.bundle/Images/\(name).\(ext)"),
        ]
