...
final class ToolExecutor {
    ...
    private func projectFocusError() -> String? {
        ...
        return "This session is on '\(sessionName)', but '\(frontmostName)' is active in Breazin. Activate '\(sessionName)' or call manage_project with action='open' before making changes."
    }
