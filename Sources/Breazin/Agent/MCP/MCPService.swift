...
final class MCPService {
    ...
    static var port: UInt16 { AppConfiguration.current.mcpPort }

    private static var enabledKey: String { "\(AppConfiguration.current.preferencesPrefix).mcp.enabled" }
