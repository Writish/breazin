...
extension GenerationView {
    ...
    var catalogReady: Bool {
        !videoModels.isEmpty && !imageModels.isEmpty
    }
    ...
    var currentProviderID: ProviderID? {
        ProviderModelCatalog.providerID(for: currentModelId)
    }

    var usesDirectProvider: Bool { currentProviderID != nil }

    var directProviderReady: Bool {
        guard let currentProviderID else { return false }
