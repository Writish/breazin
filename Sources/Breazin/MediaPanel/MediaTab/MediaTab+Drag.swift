...
extension MediaTab {
    static let folderDragScheme = "breazin-folder://"
    static let assetDragScheme = "breazin-asset://"
    static let timelineDragScheme = "breazin-timeline://"
    ...
    /// A search "moment": `breazin-asset://<id>#<start>-<end>` in source seconds
