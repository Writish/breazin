...
enum SearchIndexConfig {
    ...
    // Temporary upstream artifact dependency. Keep the real, checksummed source until
    // the exact model files are mirrored under a Breazin-controlled release channel.
