...
final class ModelDownloader: @unchecked Sendable {
    ...
    static let modelsDir = AppConfiguration.current.applicationSupportDirectory
    ...
    func install(
        ...
        let staging = fm.temporaryDirectory.appendingPathComponent("breazin-model-\(UUID().uuidString)")
