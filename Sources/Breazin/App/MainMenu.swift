...
enum MainMenuBuilder {
    ...
    private static func appMenu() -> NSMenuItem {
        let item = NSMenuItem()
        let menu = NSMenu(title: "Breazin")
        menu.addItem(withTitle: "About Breazin", action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: "")
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: "Quit Breazin", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
        item.submenu = menu
        return item
    }
