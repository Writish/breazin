...
struct MomentDragTests {
    ...
    @Test func malformedSegmentsRejected() {
        #expect(MediaTab.assetSegment(fromDragString: "breazin-asset://x#5-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "breazin-asset://x#-1-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "breazin-asset://x#junk") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "breazin-folder://x#1-2") == nil)
        #expect(MediaTab.assetId(fromDragString: "breazin-asset://x#junk") == "x")
    }
