...
struct ToolExecutorImportMediaTests {
    ...
    @Test func importBytesWritesFileAndRegistersAsset() async throws {
        ...
        let h = ToolHarness()
        h.editor.projectURL = root.appendingPathComponent("Import.breazin", isDirectory: true)
    ...
    @Test func importBytesRejectsInvalidLottieBeforePackageCommit() async {
        ...
        let h = ToolHarness()
        let package = root.appendingPathComponent("Import.breazin", isDirectory: true)
